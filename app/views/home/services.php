...
<html lang="en">
  ...
  <body>
          ...
          >
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
              <div class="navbar-nav ml-auto">
                ...
                >
                <a class="nav-item nav-link active scrollto" href="<?=BASEURL;?>/#services"
                  >Layanan Kami</a
                >
                <a class="nav-item nav-link scrollto" href="<?=BASEURL;?>/home/about"
                  >Tentang Perusahaan</a
                >
                <a class="nav-item nav-link" href="<?=BASEURL;?>/home/portfolio">Portofolio</a>
    ...
    <section id="title">
      <div class="container">
        <div class="row">
          <div class="col-12 content-wrapper" style = "padding: 10px;">
            <h4 style = "padding-top: 10px;" >Bidang Jasa CV Graha Baja</h4>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="content">
      <div class="container">
        <div class="row justify-content-between">
          <div class="col-lg-3 sidebar">
            <h5 style = "padding-top: 10px;" >Pembangunan & Renovasi</h5>
            <div class="img-about">
            <img src="<?=BASEURL;?>/img/services/service1.jpg" class="img-fluid"/>
            </div>
          </div>

          <div class="col-lg-8 content-wrapper">
            <?php require_once 'services1.html'; ?>
          </div>
        </div>
      </div>
      ...
      <div class="container mt-3">
        <div class="row justify-content-between">
          <div class="col-lg-3 sidebar">
            <h5 style = "padding-top: 10px;" >Pembuatan Pagar & Kanopi</h5>
            <div class="img-about">
            <img src="<?=BASEURL;?>/img/services/service2.jpg" class="img-fluid"/>
            </div>
          </div>

          <div class="col-lg-8 content-wrapper">
            <?php require_once 'services2.html'; ?>
          </div>
        </div>
      </div>
    </section>
