          ...
          >
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
              <div class="navbar-nav ml-auto">
                ...
                >
                <a class="nav-item nav-link scrollto" href="<?=BASEURL;?>/#services"
                  >Layanan Kami</a
                >
                <a class="nav-item nav-link active scrollto" href="<?=BASEURL;?>/home/about"
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 content-wrapper" style = "padding: 10px;">
            <h4 style = "padding-top: 10px;" >Profil CV Graha Baja</h4>
          </div>
        </div>
      </div>
    </section>
