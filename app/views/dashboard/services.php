          ...
          <section class="section">
            ...
            <div class="col-12">
                <div class="card">
                  ...
                  <h4>Pembangunan & Renovasi</h4>
                  </div>
                  
                  <div class="card-body">
                  <form method="post" action="<?=BASEURL;?>/dashboard/editservicespage1">
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Content</label>
                      <div class="col-sm-12 col-md-7">
                        <textarea name="about" class="summernote"><?php echo (is_file(dirname(__DIR__).'\Home\services1.html')) ? file_get_contents((dirname(__DIR__).'\Home\services1.html')) : '' ?></textarea>
                      </div>
                    </div>
                    <div class="form-group row mb-4">
                  ...
                  <div class="card-header">
                  <h4>Pembuatan Pagar & Kanopi</h4>
                  </div>
                  <div class="card-body">
                  <form method="post" action="<?=BASEURL;?>/dashboard/editservicespage2">
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Content</label>
                      <div class="col-sm-12 col-md-7">
                        <textarea name="about" class="summernote"><?php echo (is_file(dirname(__DIR__).'\Home\services2.html')) ? file_get_contents((dirname(__DIR__).'\Home\services2.html')) : '' ?></textarea>
                      </div>
                    </div>
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3"></label>
