                      ...
                      <table class="table table-striped mb-0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <?=$allportfolio['category'];?>
                            </td>
                            <td>
                              <?=$allportfolio['client'];?>
                            </td>
                            <td>
                              <?=$allportfolio['location'];?>
                            </td>
                            <td>
                              <?=$allportfolio['date'];?>
                            </td>
                            ...
                            <td>
                              <a
                                ...
                                title="Edit"
                                data-toggle="modal"
                                data-target="#editporto<?=$allportfolio['id'];?>"
                              ...
                              <a
                                ...
                                data-confirm-yes="location.href='<?=BASEURL;?>/dashboard/deleteallportfolio/<?=$allportfolio['id'];?>'"
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form
              action="<?=BASEURL;?>/dashboard/addallportfolio"
              method="post"
    ...
    >
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form
              action="<?=BASEURL;?>/dashboard/editallportfolio"
              method="post"
              enctype="multipart/form-data"
            >
              <div class="form-group">
              ...
              <div class="form-group">
                <label>Kategori Layanan:</label>
                <select class="custom-select" name="category">
                  <option selected value="<?=$allportfolio['category'];?>">Pilih Kategori</option>
                  <?php foreach ($data['services'] as $services) : ?>
                  <option value="<?=$services['service'];?>">
                    <?=$services['service'];?>
                  </option>
              ...
              <div class="form-group">
                ...
                <input
                  ...
                  id="location"
                  name="location"
                  value="<?=$allportfolio['location'];?>"
                />
              </div>

              <div class="form-group">
                <label for="date">Lokasi:</label>
                <input
                  type="text"
                  class="form-control"
                  id="date"
                  name="date"
                  value="<?=$allportfolio['date'];?>"
                />
              </div>
