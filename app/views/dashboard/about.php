          ...
          <section class="section">
            ...
            <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                  <form method="post" action="<?=BASEURL;?>/dashboard/editaboutpage">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <textarea name="about" class="summernote"><?php echo (is_file(dirname(__DIR__).'\Home\about.html')) ? file_get_contents((dirname(__DIR__).'\Home\about.html')) : '' ?></textarea>
                      </div>
                    </div>
                    <div class="form-group row mb-4">
